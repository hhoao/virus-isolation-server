...
public class AmsArticle implements Serializable {
     ...
     */
    public AmsArticle(Long id, String title, String author, String digest, Integer type, String readingAmount, Boolean top, Integer level, Boolean visible, String cover, Date lastModification, Date createTime) {
        this.id = id;
        this.title = title;
        this.author = author;
        this.digest = digest;
     ...
     */
    public AmsArticle(Long id, String title, String author, String digest, Integer type, String readingAmount, Boolean top, Integer level, Boolean visible, String cover, Date lastModification, Date createTime, String content) {
        this.id = id;
        this.title = title;
        this.author = author;
        this.digest = digest;
